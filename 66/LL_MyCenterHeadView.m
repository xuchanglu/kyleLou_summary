...
-(void)initMyNameLable:(CGRect)frame
{
    ...
    [self.myNameAndSexbtn setTitleColor:[UIColor whiteColor] forState:UIControlStateNormal];
...
//    [self.MyHeadViewbtn setImageForState:UIControlStateSelected withURL:[NSURL URLWithString:url] placeholderImage:[UIImage imageNamed:@"userImage"]];
    ...
    CGFloat moveWidth = [name sizeWithAttributes:@{NSFontAttributeName:[UIFont systemFontOfSize:14]}].width;
