...
static NSInteger ToastManagerContentViewTag = 9999999;
...
- (UIView *)viewForMessage:(NSString *)message title:(NSString *)title image:(UIImage *)image {
    ...
    UIView *existView = [_showInView viewWithTag:ToastManagerContentViewTag];
    if(existView){
    ...
    wrapperView.tag = ToastManagerContentViewTag;
