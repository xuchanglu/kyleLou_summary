...
static NSTimeInterval D_MINUTE = 60;
static NSTimeInterval D_HOUR = 3600;
static NSTimeInterval D_DAY	 = 86400;
static NSTimeInterval D_WEEK = 604800;
static NSTimeInterval D_YEAR = 31556926;
...
+ (NSCalendar *) currentCalendar
{
    ...
    /**
     currentCalendar取得的值会一直保持在cache中，第一次取得以后如果用户修改该系统日历设定，这个值也不会改变。如果用autoupdatingCurrentCalendar，那么每次取得的值都会是当前系统设置的日历的值。
     */
